...
ui <- fluidPage(
  title = "Measurement error bias in linear regression",
  theme = shinytheme("lumen"),
  titlePanel(h1("Measurement error bias in linear regression",
                align = "center")),
  fluidRow(
  ...
  fluidRow(
    ...
    column(2,
           ...
           numericInput("error_sd_y",
                        ...
                        step = 0.1,
                        width = "80%"),
           sliderInput("y_xrange",
                       label = "Measurement error applied to X-values:",
                       min = -10,
                       max = 10,
                       value = c(-10, 10),
                       width = "80%"),
           sliderInput("y_yrange",
                       label = "Measurement error applied to Y-values:",
                       min = -10,
                       max = 10,
                       value = c(-10, 10),
    ...
    column(2,
           ...
           tableOutput("estimates_error"))
  ),
  bsTooltip(id = "error_mean_x",
            title = "Systematic error in X",
            placement = "right",
            trigger = "hover"),
  bsTooltip(id = "error_mean_y",
            title = "Systematic error in Y",
            placement = "right",
            trigger = "hover"),
  bsTooltip(id = "error_sd_x",
            title = "Random error in X",
            placement = "right",
            trigger = "hover"),
  bsTooltip(id = "error_sd_y",
            title = "Random error in Y",
            placement = "right",
            trigger = "hover"),
  bsTooltip(id = "yrange",
            title = "Apply measurement error to Y-values in this range",
            placement = "right",
            trigger = "hover"),
  bsTooltip(id = "xrange",
            title = "Apply measurement error to X-values in this range",
            placement = "right",
            trigger = "hover"),
)